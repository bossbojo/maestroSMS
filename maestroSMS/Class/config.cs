...
namespace maestroSMS.Class
{
    public class config
    {
        ...
        public void GetConfigNow(SerialPort port) {
            Console.WriteLine("");
            Console.WriteLine("------------------------");
            Console.WriteLine("|PortName\t|{0}\t|", port.PortName);
            Console.WriteLine("|BaudRate\t|{0}\t|", port.BaudRate);
            Console.WriteLine("|DataBits\t|{0}\t|", port.DataBits);
            Console.WriteLine("|StopBits\t|{0}\t|", port.StopBits);
            Console.WriteLine("|Parity\t\t|{0}\t|", port.Parity);
            Console.WriteLine("------------------------");
            Console.WriteLine("");
        }
